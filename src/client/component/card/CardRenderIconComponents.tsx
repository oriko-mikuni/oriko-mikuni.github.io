...
const cardIconStyle: Record<string, string> = {
    'suit': "relative inline-block bg-cover w-[1.2em] h-[1.2em] rounded-full text-transparent",
    'type': "relative inline-block bg-cover w-[1.2em] h-[1.2em] rounded-full text-transparent",
    'state': "relative inline-block bg-cover w-[1.44em] h-[1.2em] text-transparent",
...
const cardIconStyleMinimize: Record<string, string> = {
    'suit': "relative inline-block align-text-top bg-cover w-[1em] h-[1em] rounded-full border border-white border-solid text-transparent",
    'type': "relative inline-block align-middle bg-cover w-[1em] h-[1em] rounded-full border border-white border-solid text-transparent",
    'state': "relative inline-block align-middle bg-cover w-[1.22em] h-[1em] border border-white border-solid text-transparent",
