...
export const HORIZONS_UPDATED_CARD_MANIFEST = new ModuleManifest({
    ...
    cardsToRemove: [
        ...
        CardName.CELTICA,
        CardName.GREEK_PROSPERITY,
        CardName.SCYTHIANS_POWER_A,
        CardName.SCYTHIANS_POWER_B,
        CardName.ATEAS,
        CardName.NOMADS,
        CardName.NOMADS_B,
        CardName.CAFALL,
        CardName.ATLANTEANS_POWER_A,
        CardName.ATLANTEANS_POWER_B,
        CardName.ADVANCED_CULTURE,
        CardName.SPREAD_OF_ATLANTIS,
        CardName.MYTHS_AND_LEGENDS,
        CardName.VAST_WEALTH,
        CardName.ATLANTEAN_FLEET,
        CardName.INDIAN_ELEPHANTS,
        CardName.INDIAN_ELEPHANTS_B,
        CardName.CHANDRAGUPTA,
        CardName.MINOAN_TRADERS,
        CardName.POTTERY,
        CardName.CRETE,
        CardName.LODESTONE_COMPASS,
        CardName.BALL_GAMES,
        CardName.UTOPIANS_POWER_A,
        CardName.UTOPIANS_POWER_B,
